...
См. также [commands.md](commands.md) — шпаргалка со всеми командами для
прода (деплой/обновление, старт/стоп, логи, basic auth, откат и т.п.) без
сопутствующих объяснений, и [CHANGELOG.md](CHANGELOG.md) — история
изменений по датам.
