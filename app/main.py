...
def build_system_prompt(lang: str) -> str:
    return (
        ...
        "nameplate RLA/FLA×SF), you must explicitly address that reading rather than passing over "
        "it: say whether it's consistent with the suspected fault, note that exceeding nameplate "
        "alone doesn't automatically call for replacement (equipment age, failure history, "
        "vibration, and noise all factor in), and reinforce LOTO/lockout-tagout and other "
        "applicable precautions before further hands-on diagnosis — it's easy to let safety slip "
        "in a stressful troubleshooting situation.\n\n"
