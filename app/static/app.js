...
const I18N = {
  ru: {
    ...
    nameplateCapacityLabel: "Мощность (охлаждение)",
    nameplateHeatingCapacityLabel: "Мощность (нагрев)",
  ...
  en: {
    ...
    nameplateCapacityLabel: "Capacity (cooling)",
    nameplateHeatingCapacityLabel: "Capacity (heating)",
    nameplateSeerLabel: "SEER",
...
function renderManufacturerStep() {
  ...
  function applyNameplateResult(data) {
    ...
    const specFields = [
      ...
      ["heating_capacity", strings.nameplateHeatingCapacityLabel],
